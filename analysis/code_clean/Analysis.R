...
source("/home/anastasia/Documents/Disser/code/functions.R") 
...
plot_cons_set_by_party_color(df_ideologies,ideology_num=3,"Democracy", party_code=1, cons_sets=list(c(1,2,3),c(1,2,3,4),c(1,2,3,4,5,6)),par_euc2) 
...
plot_cons_set_by_party_color(df_ideologies,ideology_num=5,"Market Economy", party_code=1, cons_sets=list(c(1,2,3,4,5,6),c(1,2,3,4),c(1,2,3)),par_euc2) 
